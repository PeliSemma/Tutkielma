...
Ohjelmointikieleen tutustuessa on tapana kirjoittaa klassinen "Hei maailma" -ohjelma joka tulostaa kyseisen lauseen. Koodi \ref{helloworld} on kyseisen ohjelman Rust toteutus.

\begin{code}{rust}{syntax}{}
fn main() {
    let x = 42;
    let mut y = 7;
    y += 1;
    if y == 8 {
        for i in 0..x {
            println!("y on 8 ja {} on pienempi kuin x", i);        
        }    
    }
}
\end{code}
