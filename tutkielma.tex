...
Rust hyödyntää \textit{crates.io} -paketinhallintapalvelua, joka mahdollistaa Rustia käyttävien kirjastojen asentamisen keskitetystä palvelusta käyttäen Cargo-työkalua.\cite{CratesIO} Ohjelmoija voi siten sisällyttää Rust-projektin riippuvuudet lähdekoodin mukaan, ja muut kehittäjät voivat ladata ja kääntää projektin riippumatta käytetystä käyttöjärjestelmästä. Palvelu sisältää kirjoitushetkellä yli 12,000 pakettia. Vertailun vuoksi Python-ohjelmointikielelle suunnattu \textit{Python Package Index} -palvelu sisältää yli 122,000 pakettia ja Ruby-kielen \textit{RubyGems} yli 138,000 pakettia. C ja C++ -kielille ei sijaan ole olemassa virallista paketinhallintaa, joten riippuvuuksien hallinta voi vaatia kirjastojen asentamista eri palveluista, tai niiden suoraa sisällyttämistä lähdekoodiin.
